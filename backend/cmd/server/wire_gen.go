...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	planService := service.NewPlanService(planRepository, orderRepository)
	planHandler := handler.NewPlanHandler(planService)
	orderService := service.NewOrderService(orderRepository, planRepository, subscriptionService, userRepository)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, planHandler, orderHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler)
