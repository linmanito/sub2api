...
type UserEdges struct {
	...
	// ConfirmedOrders holds the value of the confirmed_orders edge.
	ConfirmedOrders []*Order `json:"confirmed_orders,omitempty"`
...
// ConfirmedOrdersOrErr returns the ConfirmedOrders value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) ConfirmedOrdersOrErr() ([]*Order, error) {
	if e.loadedTypes[9] {
		return e.ConfirmedOrders, nil
	}
	return nil, &NotLoadedError{edge: "confirmed_orders"}
}
...
// QueryConfirmedOrders queries the "confirmed_orders" edge of the User entity.
func (_m *User) QueryConfirmedOrders() *OrderQuery {
	return NewUserClient(_m.config).QueryConfirmedOrders(_m)
}
