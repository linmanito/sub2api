...
func (_u *UserUpdate) AddConfirmedOrderIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddConfirmedOrderIDs(ids...)
	return _u
}

// AddConfirmedOrders adds the "confirmed_orders" edges to the Order entity.
func (_u *UserUpdate) AddConfirmedOrders(v ...*Order) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddConfirmedOrderIDs(ids...)
}
...
// ClearConfirmedOrders clears all "confirmed_orders" edges to the Order entity.
func (_u *UserUpdate) ClearConfirmedOrders() *UserUpdate {
	_u.mutation.ClearConfirmedOrders()
	return _u
}

// RemoveConfirmedOrderIDs removes the "confirmed_orders" edge to Order entities by IDs.
func (_u *UserUpdate) RemoveConfirmedOrderIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveConfirmedOrderIDs(ids...)
	return _u
}

// RemoveConfirmedOrders removes "confirmed_orders" edges to Order entities.
func (_u *UserUpdate) RemoveConfirmedOrders(v ...*Order) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveConfirmedOrderIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ConfirmedOrdersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.ConfirmedOrdersTable,
			Columns: []string{user.ConfirmedOrdersColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(order.FieldID, field.TypeInt64),
			},
	...
	if nodes := _u.mutation.RemovedConfirmedOrdersIDs(); len(nodes) > 0 && !_u.mutation.ConfirmedOrdersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.ConfirmedOrdersTable,
	...
	if nodes := _u.mutation.ConfirmedOrdersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.ConfirmedOrdersTable,
...
// AddConfirmedOrderIDs adds the "confirmed_orders" edge to the Order entity by IDs.
func (_u *UserUpdateOne) AddConfirmedOrderIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddConfirmedOrderIDs(ids...)
	return _u
}

// AddConfirmedOrders adds the "confirmed_orders" edges to the Order entity.
func (_u *UserUpdateOne) AddConfirmedOrders(v ...*Order) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearConfirmedOrders clears all "confirmed_orders" edges to the Order entity.
func (_u *UserUpdateOne) ClearConfirmedOrders() *UserUpdateOne {
	_u.mutation.ClearConfirmedOrders()
	return _u
}

// RemoveConfirmedOrderIDs removes the "confirmed_orders" edge to Order entities by IDs.
func (_u *UserUpdateOne) RemoveConfirmedOrderIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveConfirmedOrderIDs(ids...)
	return _u
}

// RemoveConfirmedOrders removes "confirmed_orders" edges to Order entities.
func (_u *UserUpdateOne) RemoveConfirmedOrders(v ...*Order) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
