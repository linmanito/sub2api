...
const (
	...
	EdgeOrders = "orders"
	// EdgeConfirmedOrders holds the string denoting the confirmed_orders edge name in mutations.
	EdgeConfirmedOrders = "confirmed_orders"
	...
	// ConfirmedOrdersTable is the table that holds the confirmed_orders relation/edge.
	ConfirmedOrdersTable = "orders"
	// ConfirmedOrdersInverseTable is the table name for the Order entity.
	// It exists in this package in order to avoid circular dependency with the "order" package.
	ConfirmedOrdersInverseTable = "orders"
	// ConfirmedOrdersColumn is the table column denoting the confirmed_orders relation/edge.
	ConfirmedOrdersColumn = "confirmed_by"
...
// ByConfirmedOrdersCount orders the results by confirmed_orders count.
func ByConfirmedOrdersCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newConfirmedOrdersStep(), opts...)
	}
}

// ByConfirmedOrders orders the results by confirmed_orders terms.
func ByConfirmedOrders(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newConfirmedOrdersStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newConfirmedOrdersStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(ConfirmedOrdersInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, ConfirmedOrdersTable, ConfirmedOrdersColumn),
	)
}
