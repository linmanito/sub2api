...
const userNavItems = computed(() => {
  const items = [
    ...
    { path: '/plans', label: t('nav.plans'), icon: ShoppingBagIcon, hideInSimpleMode: true },
...
const adminNavItems = computed(() => {
  const baseItems = [
    ...
    { path: '/admin/plans', label: t('nav.planManagement'), icon: ShoppingBagIcon, hideInSimpleMode: true },
    { path: '/admin/orders', label: t('nav.orderManagement'), icon: ClipboardListIcon, hideInSimpleMode: true },
