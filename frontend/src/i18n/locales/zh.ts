export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        title: '支付配置',
        description: '配置套餐支付的收款二维码和说明',
        alipayQrcode: '支付宝收款码',
        wechatQrcode: '微信收款码',
        serviceQrcode: '客服二维码',
        paymentNote: '支付说明',
        paymentNotePlaceholder: '支付后请备注您的用户名，管理员将在1-24小时内确认您的订单',
        paymentNoteHint: '此说明将显示在用户支付页面',
        upload: '上传',
        qrcodeSizeError: '二维码图片不能超过 500KB，当前 {size}KB',
        qrcodeTypeError: '请上传图片格式的二维码',
    ...
    plans: {
      ...
      noGroups: '无关联分组',
      noPlansYet: '暂无套餐',
      createFirstPlan: '点击上方按钮创建您的第一个套餐',
      columns: {
        name: '套餐名称',
        price: '价格/有效期',
        concurrency: '并发数',
      ...
      enterPlanName: '输入套餐名称',
      optionalDescription: '可选描述',
      priceHint: '请输入美元价格',
      featurePlaceholder: '输入特性描述',
      addFeature: '添加特性',
      selectGroups: '选择关联的分组',
      groupsHint: '用户订阅后将获得所选分组的访问权限',
      creating: '创建中...',
      updating: '更新中...',
      ...
      deleteFailed: '删除套餐失败',
      deleteConfirmMessage: '确定要删除套餐 "{name}" 吗？此操作不可恢复。',
      enableSuccess: '套餐已启用',
      disableSuccess: '套餐已禁用',
      statusUpdateFailed: '状态更新失败',
      failedToLoad: '加载套餐列表失败'
    },

    // Orders Management
    orders: {
      title: '订单管理',
      description: '管理用户的套餐订单',
      allStatus: '全部状态',
      days: '天',
      noOrdersYet: '暂无订单',
      noOrdersDesc: '用户提交的订单将显示在这里',
      columns: {
        id: '订单号',
        user: '用户',
        plan: '套餐',
      ...
      orderDetails: '订单详情',
      notes: '备注',
      optionalNotes: '可选备注信息',
      rejectReason: '拒绝原因',
      rejectReasonPlaceholder: '请输入拒绝原因（可选）',
      confirmHint: '确认订单后，系统将为用户创建订阅并增加相应的并发数。',
      rejectHint: '拒绝订单后，用户需要重新提交订单。',
      confirmAction: '确认订单',
      rejectAction: '拒绝订单',
      orderId: '订单号',
      user: '用户',
  ...
  payment: {
    title: '订单支付',
    description: '完成支付以激活套餐',
    orderAmount: '订单金额',
    scanToPay: '扫码支付',
    scanToPayDesc: '请使用支付宝或微信扫描下方二维码完成支付',
    alipay: '支付宝',
    wechat: '微信支付',
    alipayHint: '请使用支付宝扫描二维码',
    wechatHint: '请使用微信扫描二维码',
    serviceHint: '扫码添加客服微信获取帮助',
    noQrCode: '暂无二维码',
    paymentNote: '支付说明',
    contactService: '小孟微信',
    contactServiceDesc: '支付遇到问题？扫码联系客服获取帮助',
    cancelOrder: '取消订单',
    checkStatus: '检查支付状态',
    stillPending: '订单仍在等待支付确认',
    orderConfirmed: '订单已确认！',
    orderConfirmedDesc: '您的订阅已激活，感谢您的支持',
    orderRejected: '订单已被拒绝',
    orderRejectedDesc: '您的订单未通过审核，如有疑问请联系客服',
    orderCancelled: '订单已取消',
    orderCancelledDesc: '此订单已被取消',
    backToPlans: '返回套餐页',
    loadFailed: '加载支付信息失败',
    cancelFailed: '取消订单失败',
    orderCancelledSuccess: '订单已成功取消'
  },
